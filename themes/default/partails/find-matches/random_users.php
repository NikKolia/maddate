    ...
    <div class="card center">
        ...
        <div class="card-content">
            ...
            <div class="rand_bottom_bar">
                ...
                <button class="btn waves-effect like" id="like_btn" data-userid="<?php echo $random_user->id;?>" data-ajax-post="/useractions/like" data-ajax-params="userid=<?php echo $random_user->id;?>&username=<?php echo $random_user->username;?>" data-ajax-callback="callback_like" onclick="likedUser(<?php echo $random_user->id;?>)">
